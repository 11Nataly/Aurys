...
from app.controllers import tecnica_favorita_controller  # Importa el controlador de técnica favorita
...
app.include_router(tecnica_favorita_controller.router)  # Incluye el router de técnica favorita
